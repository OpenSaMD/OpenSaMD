...
class DependencyGraphEcosystem(sgqlc.types.Enum):
    __schema__ = github_schema
    __choices__ = ('ACTIONS', 'COMPOSER', 'GO', 'MAVEN', 'NPM', 'NUGET', 'PIP', 'RUBYGEMS')
...
class FundingPlatform(sgqlc.types.Enum):
    __schema__ = github_schema
    __choices__ = ('COMMUNITY_BRIDGE', 'CUSTOM', 'GITHUB', 'ISSUEHUNT', 'KO_FI', 'LFX_CROWDFUNDING', 'LIBERAPAY', 'OPEN_COLLECTIVE', 'OTECHIE', 'PATREON', 'TIDELIFT')
...
class ProjectNextFieldType(sgqlc.types.Enum):
    __schema__ = github_schema
    __choices__ = ('ASSIGNEES', 'DATE', 'ITERATION', 'LABELS', 'LINKED_PULL_REQUESTS', 'MILESTONE', 'NUMBER', 'REPOSITORY', 'REVIEWERS', 'SINGLE_SELECT', 'TEXT', 'TITLE', 'TRACKS')
...
class CreateBranchProtectionRuleInput(sgqlc.types.Input):
    __schema__ = github_schema
    __field_names__ = ('repository_id', 'pattern', 'requires_approving_reviews', 'required_approving_review_count', 'requires_commit_signatures', 'requires_linear_history', 'allows_force_pushes', 'allows_deletions', 'is_admin_enforced', 'requires_status_checks', 'requires_strict_status_checks', 'requires_code_owner_reviews', 'dismisses_stale_reviews', 'restricts_review_dismissals', 'review_dismissal_actor_ids', 'bypass_pull_request_actor_ids', 'bypass_force_push_actor_ids', 'restricts_pushes', 'push_actor_ids', 'required_status_check_contexts', 'required_status_checks', 'requires_conversation_resolution', 'client_mutation_id')
    repository_id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='repositoryId')
...
class CreateSponsorsTierInput(sgqlc.types.Input):
    __schema__ = github_schema
    __field_names__ = ('sponsorable_id', 'sponsorable_login', 'amount', 'is_recurring', 'repository_id', 'repository_owner_login', 'repository_name', 'welcome_message', 'description', 'publish', 'client_mutation_id')
    sponsorable_id = sgqlc.types.Field(ID, graphql_name='sponsorableId')
    sponsorable_login = sgqlc.types.Field(String, graphql_name='sponsorableLogin')
...
class CreateSponsorshipInput(sgqlc.types.Input):
    __schema__ = github_schema
    __field_names__ = ('sponsor_id', 'sponsor_login', 'sponsorable_id', 'sponsorable_login', 'tier_id', 'amount', 'is_recurring', 'receive_emails', 'privacy_level', 'client_mutation_id')
    sponsor_id = sgqlc.types.Field(ID, graphql_name='sponsorId')
    sponsor_login = sgqlc.types.Field(String, graphql_name='sponsorLogin')
    sponsorable_id = sgqlc.types.Field(ID, graphql_name='sponsorableId')
    sponsorable_login = sgqlc.types.Field(String, graphql_name='sponsorableLogin')
...
class StartRepositoryMigrationInput(sgqlc.types.Input):
    __schema__ = github_schema
    __field_names__ = ('source_id', 'owner_id', 'source_repository_url', 'repository_name', 'continue_on_error', 'git_archive_url', 'metadata_archive_url', 'access_token', 'github_pat', 'client_mutation_id')
    source_id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='sourceId')
    owner_id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='ownerId')
...
class UpdateBranchProtectionRuleInput(sgqlc.types.Input):
    __schema__ = github_schema
    __field_names__ = ('branch_protection_rule_id', 'pattern', 'requires_approving_reviews', 'required_approving_review_count', 'requires_commit_signatures', 'requires_linear_history', 'allows_force_pushes', 'allows_deletions', 'is_admin_enforced', 'requires_status_checks', 'requires_strict_status_checks', 'requires_code_owner_reviews', 'dismisses_stale_reviews', 'restricts_review_dismissals', 'review_dismissal_actor_ids', 'bypass_pull_request_actor_ids', 'bypass_force_push_actor_ids', 'restricts_pushes', 'push_actor_ids', 'required_status_check_contexts', 'required_status_checks', 'requires_conversation_resolution', 'client_mutation_id')
    branch_protection_rule_id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='branchProtectionRuleId')
...
class UpdateSponsorshipPreferencesInput(sgqlc.types.Input):
    __schema__ = github_schema
    __field_names__ = ('sponsor_id', 'sponsor_login', 'sponsorable_id', 'sponsorable_login', 'receive_emails', 'privacy_level', 'client_mutation_id')
    sponsor_id = sgqlc.types.Field(ID, graphql_name='sponsorId')
    sponsor_login = sgqlc.types.Field(String, graphql_name='sponsorLogin')
    sponsorable_id = sgqlc.types.Field(ID, graphql_name='sponsorableId')
    sponsorable_login = sgqlc.types.Field(String, graphql_name='sponsorableLogin')
...
class Migration(sgqlc.types.Interface):
    __schema__ = github_schema
    __field_names__ = ('continue_on_error', 'created_at', 'failure_reason', 'id', 'migration_source', 'source_url', 'state')
...
class Mutation(sgqlc.types.Type):
    ...
    add_project_next_item = sgqlc.types.Field(AddProjectNextItemPayload, graphql_name='addProjectNextItem', args=sgqlc.types.ArgDict((
    ...
    delete_project_next_item = sgqlc.types.Field(DeleteProjectNextItemPayload, graphql_name='deleteProjectNextItem', args=sgqlc.types.ArgDict((
    ...
    update_project_next = sgqlc.types.Field('UpdateProjectNextPayload', graphql_name='updateProjectNext', args=sgqlc.types.ArgDict((
        ('input', sgqlc.types.Arg(sgqlc.types.non_null(UpdateProjectNextInput), graphql_name='input', default=None)),
))
    )
    update_project_next_item_field = sgqlc.types.Field('UpdateProjectNextItemFieldPayload', graphql_name='updateProjectNextItemField', args=sgqlc.types.ArgDict((
...
class ProjectNextOwner(sgqlc.types.Interface):
    ...
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    project_next = sgqlc.types.Field('ProjectNext', graphql_name='projectNext', args=sgqlc.types.ArgDict((
        ('number', sgqlc.types.Arg(sgqlc.types.non_null(Int), graphql_name='number', default=None)),
))
    )
    projects_next = sgqlc.types.Field(sgqlc.types.non_null(ProjectNextConnection), graphql_name='projectsNext', args=sgqlc.types.ArgDict((
        ('after', sgqlc.types.Arg(String, graphql_name='after', default=None)),
        ('before', sgqlc.types.Arg(String, graphql_name='before', default=None)),
        ('first', sgqlc.types.Arg(Int, graphql_name='first', default=None)),
        ('last', sgqlc.types.Arg(Int, graphql_name='last', default=None)),
...
class RefUpdateRule(sgqlc.types.Type):
    __schema__ = github_schema
    __field_names__ = ('allows_deletions', 'allows_force_pushes', 'pattern', 'required_approving_review_count', 'required_status_check_contexts', 'requires_code_owner_reviews', 'requires_conversation_resolution', 'requires_linear_history', 'requires_signatures', 'viewer_allowed_to_dismiss_reviews', 'viewer_can_push')
...
class RepositoryInfo(sgqlc.types.Interface):
    __schema__ = github_schema
    __field_names__ = ('created_at', 'description', 'description_html', 'fork_count', 'has_issues_enabled', 'has_projects_enabled', 'has_wiki_enabled', 'homepage_url', 'is_archived', 'is_fork', 'is_in_organization', 'is_locked', 'is_mirror', 'is_private', 'is_template', 'license_info', 'lock_reason', 'mirror_url', 'name', 'name_with_owner', 'open_graph_image_url', 'owner', 'pushed_at', 'resource_path', 'short_description_html', 'updated_at', 'url', 'uses_custom_open_graph_image', 'visibility')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
    description = sgqlc.types.Field(String, graphql_name='description')
...
class Sponsorable(sgqlc.types.Interface):
    __schema__ = github_schema
    __field_names__ = ('estimated_next_sponsors_payout_in_cents', 'has_sponsors_listing', 'is_sponsored_by', 'is_sponsoring_viewer', 'monthly_estimated_sponsors_income_in_cents', 'sponsoring', 'sponsors', 'sponsors_activities', 'sponsors_listing', 'sponsorship_for_viewer_as_sponsor', 'sponsorship_for_viewer_as_sponsorable', 'sponsorship_newsletters', 'sponsorships_as_maintainer', 'sponsorships_as_sponsor', 'viewer_can_sponsor', 'viewer_is_sponsoring')
...
class App(sgqlc.types.Type, Node):
    __schema__ = github_schema
    __field_names__ = ('created_at', 'database_id', 'description', 'ip_allow_list_entries', 'logo_background_color', 'logo_url', 'name', 'slug', 'updated_at', 'url')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
    database_id = sgqlc.types.Field(Int, graphql_name='databaseId')
    description = sgqlc.types.Field(String, graphql_name='description')
    ip_allow_list_entries = sgqlc.types.Field(sgqlc.types.non_null(IpAllowListEntryConnection), graphql_name='ipAllowListEntries', args=sgqlc.types.ArgDict((
...
class BranchProtectionRule(sgqlc.types.Type, Node):
    __schema__ = github_schema
    __field_names__ = ('allows_deletions', 'allows_force_pushes', 'branch_protection_rule_conflicts', 'bypass_force_push_allowances', 'bypass_pull_request_allowances', 'creator', 'database_id', 'dismisses_stale_reviews', 'is_admin_enforced', 'matching_refs', 'pattern', 'push_allowances', 'repository', 'required_approving_review_count', 'required_status_check_contexts', 'required_status_checks', 'requires_approving_reviews', 'requires_code_owner_reviews', 'requires_commit_signatures', 'requires_conversation_resolution', 'requires_linear_history', 'requires_status_checks', 'requires_strict_status_checks', 'restricts_pushes', 'restricts_review_dismissals', 'review_dismissal_allowances')
    allows_deletions = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='allowsDeletions')
    allows_force_pushes = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='allowsForcePushes')
...
class Discussion(sgqlc.types.Type, Comment, Updatable, Deletable, Labelable, Lockable, RepositoryNode, Subscribable, Reactable, Votable, Node):
    __schema__ = github_schema
    __field_names__ = ('answer', 'answer_chosen_at', 'answer_chosen_by', 'category', 'comments', 'number', 'resource_path', 'title', 'url')
...
class DraftIssue(sgqlc.types.Type, Node):
    __schema__ = github_schema
    __field_names__ = ('assignees', 'body', 'body_html', 'body_text', 'created_at', 'creator', 'project', 'project_item', 'title', 'updated_at')
    assignees = sgqlc.types.Field(sgqlc.types.non_null(UserConnection), graphql_name='assignees', args=sgqlc.types.ArgDict((
        ('after', sgqlc.types.Arg(String, graphql_name='after', default=None)),
        ('before', sgqlc.types.Arg(String, graphql_name='before', default=None)),
        ('first', sgqlc.types.Arg(Int, graphql_name='first', default=None)),
...
class Enterprise(sgqlc.types.Type, Node):
    __schema__ = github_schema
    __field_names__ = ('avatar_url', 'billing_info', 'created_at', 'database_id', 'description', 'description_html', 'location', 'members', 'name', 'organizations', 'owner_info', 'resource_path', 'slug', 'url', 'viewer_is_admin', 'website_url')
    avatar_url = sgqlc.types.Field(sgqlc.types.non_null(URI), graphql_name='avatarUrl', args=sgqlc.types.ArgDict((
        ('size', sgqlc.types.Arg(Int, graphql_name='size', default=None)),
))
    )
...
class Issue(sgqlc.types.Type, Node, Assignable, Closable, Comment, Updatable, UpdatableComment, Labelable, Lockable, Reactable, RepositoryNode, Subscribable, UniformResourceLocatable, ProjectNextOwner):
    __schema__ = github_schema
    __field_names__ = ('body_resource_path', 'body_url', 'comments', 'hovercard', 'is_pinned', 'is_read_by_viewer', 'milestone', 'number', 'participants', 'project_cards', 'project_next_items', 'state', 'timeline_items', 'title', 'title_html')
    ...
    project_next_items = sgqlc.types.Field(sgqlc.types.non_null(ProjectNextItemConnection), graphql_name='projectNextItems', args=sgqlc.types.ArgDict((
...
class ProjectNext(sgqlc.types.Type, Node, Closable, Updatable):
    __schema__ = github_schema
    __field_names__ = ('created_at', 'creator', 'database_id', 'description', 'fields', 'items', 'number', 'owner', 'public', 'repositories', 'resource_path', 'short_description', 'title', 'updated_at', 'url', 'views')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
    creator = sgqlc.types.Field(Actor, graphql_name='creator')
    database_id = sgqlc.types.Field(Int, graphql_name='databaseId')
    description = sgqlc.types.Field(String, graphql_name='description')
    fields = sgqlc.types.Field(sgqlc.types.non_null(ProjectNextFieldConnection), graphql_name='fields', args=sgqlc.types.ArgDict((
        ('after', sgqlc.types.Arg(String, graphql_name='after', default=None)),
        ('before', sgqlc.types.Arg(String, graphql_name='before', default=None)),
        ('first', sgqlc.types.Arg(Int, graphql_name='first', default=None)),
        ('last', sgqlc.types.Arg(Int, graphql_name='last', default=None)),
    ...
    items = sgqlc.types.Field(sgqlc.types.non_null(ProjectNextItemConnection), graphql_name='items', args=sgqlc.types.ArgDict((
        ('after', sgqlc.types.Arg(String, graphql_name='after', default=None)),
        ('before', sgqlc.types.Arg(String, graphql_name='before', default=None)),
        ('first', sgqlc.types.Arg(Int, graphql_name='first', default=None)),
        ('last', sgqlc.types.Arg(Int, graphql_name='last', default=None)),
    ...
    updated_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='updatedAt')
    url = sgqlc.types.Field(sgqlc.types.non_null(URI), graphql_name='url')
    views = sgqlc.types.Field(sgqlc.types.non_null(ProjectViewConnection), graphql_name='views', args=sgqlc.types.ArgDict((
        ('after', sgqlc.types.Arg(String, graphql_name='after', default=None)),
        ('before', sgqlc.types.Arg(String, graphql_name='before', default=None)),
        ('first', sgqlc.types.Arg(Int, graphql_name='first', default=None)),
        ('last', sgqlc.types.Arg(Int, graphql_name='last', default=None)),
...
class ProjectNextItem(sgqlc.types.Type, Node):
    __schema__ = github_schema
    __field_names__ = ('content', 'created_at', 'creator', 'database_id', 'field_values', 'is_archived', 'project', 'title', 'type', 'updated_at')
    content = sgqlc.types.Field('ProjectNextItemContent', graphql_name='content')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
    creator = sgqlc.types.Field(Actor, graphql_name='creator')
    database_id = sgqlc.types.Field(Int, graphql_name='databaseId')
    field_values = sgqlc.types.Field(sgqlc.types.non_null(ProjectNextItemFieldValueConnection), graphql_name='fieldValues', args=sgqlc.types.ArgDict((
        ('after', sgqlc.types.Arg(String, graphql_name='after', default=None)),
        ('before', sgqlc.types.Arg(String, graphql_name='before', default=None)),
        ('first', sgqlc.types.Arg(Int, graphql_name='first', default=None)),
        ('last', sgqlc.types.Arg(Int, graphql_name='last', default=None)),
...
class ProjectView(sgqlc.types.Type, Node):
    __schema__ = github_schema
    __field_names__ = ('created_at', 'database_id', 'filter', 'group_by', 'layout', 'name', 'number', 'project', 'sort_by', 'updated_at', 'vertical_group_by', 'visible_fields')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
    database_id = sgqlc.types.Field(Int, graphql_name='databaseId')
...
class RepositoryVulnerabilityAlert(sgqlc.types.Type, Node, RepositoryNode):
    __schema__ = github_schema
    __field_names__ = ('created_at', 'dependabot_update', 'dismiss_reason', 'dismissed_at', 'dismisser', 'fix_reason', 'fixed_at', 'number', 'security_advisory', 'security_vulnerability', 'state', 'vulnerable_manifest_filename', 'vulnerable_manifest_path', 'vulnerable_requirements')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
...
class SecurityAdvisory(sgqlc.types.Type, Node):
    __schema__ = github_schema
    __field_names__ = ('cvss', 'cwes', 'database_id', 'description', 'ghsa_id', 'identifiers', 'notifications_permalink', 'origin', 'permalink', 'published_at', 'references', 'severity', 'summary', 'updated_at', 'vulnerabilities', 'withdrawn_at')
...
class SponsorsListing(sgqlc.types.Type, Node):
    __schema__ = github_schema
    __field_names__ = ('active_goal', 'created_at', 'full_description', 'full_description_html', 'is_public', 'name', 'next_payout_date', 'short_description', 'slug', 'sponsorable', 'tiers')
...
class Sponsorship(sgqlc.types.Type, Node):
    __schema__ = github_schema
    __field_names__ = ('created_at', 'is_one_time_payment', 'is_sponsor_opted_into_email', 'privacy_level', 'sponsor_entity', 'sponsorable', 'tier', 'tier_selected_at')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
...
class WorkflowRun(sgqlc.types.Type, Node):
    __schema__ = github_schema
    __field_names__ = ('check_suite', 'created_at', 'database_id', 'deployment_reviews', 'pending_deployment_requests', 'resource_path', 'run_number', 'updated_at', 'url', 'workflow')
    check_suite = sgqlc.types.Field(sgqlc.types.non_null(CheckSuite), graphql_name='checkSuite')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
    database_id = sgqlc.types.Field(Int, graphql_name='databaseId')
